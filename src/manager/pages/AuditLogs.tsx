...
export default function AuditLogs() {
  ...
  const translateActionType = (type: string) => {
    const translations: Record<string, string> = {
      ...
      'schedule_changed': 'Horario Base Modificado',
      'shift_type_added': 'Tipo Jornada Creado',
      'shift_type_edited': 'Tipo Jornada Modificado',
      'shift_type_deleted': 'Tipo Jornada Eliminado',
      'leave_policy_added': 'Política Permiso Creada',
      'leave_policy_edited': 'Política Permiso Modificada',
      'leave_policy_deleted': 'Política Permiso Eliminada',
      'general_settings_changed': 'Ajustes Generales Modificados',
      'permissions_changed': 'Permisos Modificados',
      'holiday_added': 'Festivo Creado',
      'holiday_edited': 'Festivo Modificado',
      ...
      'leave_deleted': 'Solicitud Permiso Eliminada',
      'manual_clock_in_out': 'Fichaje Manual',
      'time_entry_edited': 'Fichaje Modificado',
      'time_entry_deleted': 'Fichaje Eliminado',
      'force_clock_out': 'Salida Forzada',
      'shift_added': 'Turno Creado',
      'shift_edited': 'Turno Modificado',
