...
const Settings = () => {
  ...
  const [shiftTypes, setShiftTypes] = useState([
    { id: 'j-1', name: 'Mañana', color: 'bg-blue-500', hex: '#3b82f6', start: '08:00', end: '16:00', duration: '8h', isSplit: false, start2: '16:00', end2: '20:00', breakMins: 0, breakPaid: false, hasPlus: false },
    { id: 'j-2', name: 'Tarde', color: 'bg-orange-500', hex: '#f97316', start: '16:00', end: '00:00', duration: '8h', isSplit: false, start2: '16:00', end2: '20:00', breakMins: 0, breakPaid: false, hasPlus: false },
    { id: 'j-3', name: 'Noche', color: 'bg-purple-600', hex: '#9333ea', start: '00:00', end: '08:00', duration: '8h', isSplit: false, start2: '16:00', end2: '20:00', breakMins: 0, breakPaid: false, hasPlus: true },
    { id: 'j-4', name: 'Partido', color: 'bg-emerald-500', hex: '#10b981', start: '10:00', end: '14:00', duration: '8h', isSplit: true, start2: '16:00', end2: '20:00', breakMins: 0, breakPaid: false, hasPlus: false },
    { id: 'j-5', name: 'Refuerzo', color: 'bg-pink-400', hex: '#f472b6', start: '12:00', end: '16:00', duration: '4h', isSplit: false, start2: '16:00', end2: '20:00', breakMins: 0, breakPaid: false, hasPlus: false },
  ]);
